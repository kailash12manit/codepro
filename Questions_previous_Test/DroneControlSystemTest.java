...
public class DroneControlSystemTest {
	...
	public int[] testInput_2_1 = {3,7,4,2,1 }; //TODO: Problem (2-1) 1, 1, 1, 1, 1 => When only 1 drone is dispatched
	public int[] testInput_2_2 = {5,6,4,2,1}; //TODO: Problem (2-2) 2, 2, 2, 2, 2 => When only 2 drone is dispatched
	public int[] testInput_2_3 = {2,3,5,6,7}; //TODO: Problem (2-3) 1, 1, 2, 2, 1 => When only 1, 2 drone are dispatched simultaneously
	public int[] testInput_2_4 = {7,5,1,3,6}; //TODO: Problem (2-4) 1, 2, 2, 1, 2 => When only 1, 2 drone are dispatched simultaneously
